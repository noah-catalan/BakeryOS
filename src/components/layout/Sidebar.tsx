    ...
    return (
        <>
            ...
            <aside
                ref={sidebarRef}
                className={`
                    fixed inset-y-0 left-0 z-50 flex flex-col border-r border-slate-200 bg-white transition-all duration-300 ease-in-out print:hidden
                        ...
                        <div>
                            ...
                            <div className="space-y-1">
                                <Link
                                    ...
                                    title="Dashboard"
                                    className={`flex items-center ${isCollapsed ? 'md:justify-center px-0' : 'gap-3 px-3'} rounded-md py-2 text-sm font-medium transition-colors ${isActive('/') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}
                                >
                                ...
                                <Link
                                    ...
                                    onClick={handleLinkClick}
                                    title="Inventario"
                                    className={`flex items-center ${isCollapsed ? 'md:justify-center px-0' : 'gap-3 px-3'} rounded-md py-2 text-sm font-medium transition-colors ${isActive('/inventario') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}
                                >
                                ...
                                <Link
                                    ...
                                    onClick={handleLinkClick}
                                    title="Producción"
                                    className={`flex items-center ${isCollapsed ? 'md:justify-center px-0' : 'gap-3 px-3'} rounded-md py-2 text-sm font-medium transition-colors ${isActive('/produccion') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}
                                >
                                ...
                                <Link
                                    ...
                                    className={`flex items-center ${isCollapsed ? 'md:justify-center px-0' : 'gap-3 px-3'} rounded-md py-2 text-sm font-medium transition-colors ${isActive('/clientes') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}
                                >
                        ...
                        <div>
                            ...
                            <div className="space-y-1">
                                <Link
                                    ...
                                    onClick={handleLinkClick}
                                    title="Facturación"
                                    className={`flex items-center ${isCollapsed ? 'md:justify-center px-0' : 'gap-3 px-3'} rounded-md py-2 text-sm font-medium transition-colors ${isActive('/facturacion') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}
                                >
                                ...
                                <Link
                                    ...
                                    onClick={handleLinkClick}
                                    title="Configuración"
                                    className={`flex items-center ${isCollapsed ? 'md:justify-center px-0' : 'gap-3 px-3'} rounded-md py-2 text-sm font-medium transition-colors ${isActive('/configuracion') ? 'bg-blue-50 text-blue-700' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}
                                >
