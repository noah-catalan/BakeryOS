...
import { FileText, Plus, CheckCircle, Clock, Trash2, Download, AlertCircle } from "lucide-react";
                                        ...
                                        {facturas.map(fac => (
                                            <tr key={fac.id} className="hover:bg-slate-50">
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                                    ...
                                                    <button className="text-slate-400 hover:text-slate-600 p-1" title="PDF (Demo)">
                                                        <Download size={18} />
                                                    </button>
